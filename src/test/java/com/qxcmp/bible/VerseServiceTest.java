...
public class VerseServiceTest {
    ...
    public void testSearchWholeChapter() throws Exception {
        ...
        assertEquals("神看光是好的、就把光暗分开了。 ", searchResponse.getVerses().get(3).getContent());
    }
    ...
    public void testSearchSingleVerse() throws Exception {
        ...
        assertEquals("神爱世人、甚至将他的独生子赐给他们、叫一切信他的、不至灭亡、反得永生。 ", searchResponse.getVerses().get(0).getContent());
    }
    ...
    public void testSearchRange() throws Exception {
        ...
        assertEquals("然而有一件事我要责备你、就是你把起初的爱心离弃了。 ", searchResponse.getVerses().get(0).getContent());
    }
}